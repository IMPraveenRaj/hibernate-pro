...
public class StudentApp {
	...
	public Song retreiveSong_usingLoad(int id) {
		...
		// to create the session factory we need to setup a data source just keep things
		// in the mind
	...
	public static void main(String[] args) {
		...
		/*
		 * Phone personnalcontact= new Phone();
		 * personnalcontact.setMobileNo("+32497354080");
		 * personnalcontact.setOfficeNo("+919688098991");
		 * 
		 * Phone officialContact= new Phone();
		 * officialContact.setMobileNo("+42497354080");
		 * officialContact.setOfficeNo("+929688098991");
		 */
		...
		// address.setPersonnalcontact(personnalcontact);
		// address.setOfficialContact(officialContact);
