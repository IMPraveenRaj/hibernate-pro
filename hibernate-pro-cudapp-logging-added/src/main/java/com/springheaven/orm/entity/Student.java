...
public class Student {
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "addressLine1", 
	column = @Column(name="home_address_line1",length = 200,nullable=false)),
		@AttributeOverride(name = "addressLine2", 
		column = @Column(name="home_address_line2",length = 200,nullable=false)),
		@AttributeOverride(name = "city", 
		column = @Column(name="home_city",length = 200,nullable=false)),
		@AttributeOverride(name = "country", 
		column = @Column(name="home_country",length = 200,nullable=false))})	
	...
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "addressLine1", 
	column = @Column(name="hostel_address_line1",length = 200,nullable=false)),
		@AttributeOverride(name = "addressLine2", 
		column = @Column(name="hostel_address_line2",length = 200,nullable=false)),
		@AttributeOverride(name = "city", 
		column = @Column(name="hostel_city",length = 200,nullable=false)),
		@AttributeOverride(name = "country", 
		column = @Column(name="hostel_country",length = 200,nullable=false))})	
